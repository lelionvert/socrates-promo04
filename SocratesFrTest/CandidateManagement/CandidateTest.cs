...
namespace SocratesFrTest.CandidateManagement
{
    public class CandidateTest
    {
        ...
        {
            Candidate candidateOne = new Candidate("Toto", Email.EmailBuilder("toto@gmail.com"));
            Check.That(candidateOne.Equals(new Candidate("Toto", Email.EmailBuilder("toto@gmail.com")))).IsTrue();
        }
        ...
        {
            Candidate candidateOne = new Candidate("Toto", Email.EmailBuilder("toto@gmail.com"));
            Candidate candidateTwo = new Candidate("Toto", Email.EmailBuilder("toto@gmail.com"));
